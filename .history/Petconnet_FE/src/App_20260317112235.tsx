...
const SubscriptionPaymentPage = lazy(
  () => import("./pages/payment/SubscriptionPaymentPage")
);
    ...
    <Suspense fallback={<PageLoader text="Đang tải trang..." />}>
      <Routes>
        ...
        >
          ...
          <Route path="payments/approval" element={<AdminPaymentManagementPage />} />
          <Route path="payment-approval" element={<AdminPaymentManagementPage />} />
