...
import registerImage from "../../assets/image/register.png"; // Đường dẫn hình ảnh đăng ký
import logoImage from "../../assets/image/Logo.png"; // Đường dẫn logo
    ...
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="hidden lg:block lg:w-1/2 relative">
          <img
            src={registerImage || "/assets/image/register.png"}
            alt="Register"
          ...
          <div className="max-w-sm w-full">
            <div className="p-4">
              ...
              <form className="space-y-3" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full bg-green-600 text-white hover:bg-green-700 py-2 rounded-lg font-medium transition-colors"
                >
                  Đăng ký
                </button>
              </form>
