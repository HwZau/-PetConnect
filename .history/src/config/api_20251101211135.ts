...
export const API_ENDPOINTS = {
  ...
  COMMUNITY: {
    ...
    POST_DETAIL: (id: string) => `/api/v1/Post/${id}`,
    UPDATE_POST: (id: string) => `/api/v1/Post/${id}`,
    DELETE_POST: (id: string) => `/api/v1/Post/${id}`,
    LIKE_POST: (id: string) => `/api/v1/community/posts/${id}/like`,
    COMMENT: (id: string) => `/api/v1/community/posts/${id}/comments`,
