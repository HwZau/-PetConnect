...
const CustomerModal = ({ isOpen, onClose, onSubmit, petTypes, petBreeds }: CustomerModalProps) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleResetAndClose} title={t('Thêm Khách Hàng Mới','Add New Customer')}>
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
          
          {/* Cột trái: Thông tin khách hàng */}
          <div>
            <h4 className="font-bold text-lg text-gray-700 mb-4  pb-2">{t('Thông tin Khách hàng','Customer Information')}</h4>
            <FormInput
          ...
          <div>
            <h4 className="font-bold text-lg text-gray-700 mb-4  pb-2">{t('Thông tin Thú cưng (Tùy chọn)','Pet Information (Optional)')}</h4>
            ...
            <FormInput
              label={t('Loại thú cưng','Pet Type')}
              name="petType"
              type="select"
              icon={<FaDog />}
            ...
            >
              <option value="">{t('Chọn loại thú cưng','Select pet type')}</option>
              {petTypes.map(type => (
            ...
            <FormInput
              label={t('Giống thú cưng','Pet Breed')}
              name="petBreed"
              type="select"
              icon={<FaDog />}
            ...
            >
              <option value="">{t('Chọn giống','Select breed')}</option>
            ...
            <FormInput
              ...
              handleInputChange={handleInputChange}
            >
              <option value="">{t('Chọn giới tính','Select gender')}</option>
              <option value="male" className="text-gray-900">{t('Đực','Male')}</option>
              <option value="female" className="text-gray-900">{t('Cái','Female')}</option>
            </FormInput>
          </div>
        </div>
