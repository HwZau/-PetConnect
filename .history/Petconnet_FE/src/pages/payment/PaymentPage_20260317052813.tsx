...
const PaymentPage = () => {
  ...
  const [paymentMethod, setPaymentMethod] = useState<"momo" | "vnpay" | "tpbank">("momo");
    ...
    try {
      ...
      const methodCode =
        paymentMethod === "momo"
          ...
          : PaymentMethodCode.VNPAY; // VNPAY code (3) is used for TPBank too

      const description =
        paymentMethod === "momo"
          ? "Thanh toán qua ví MoMo"
          : "Thanh toán qua TPBank";
      ...
      const storedPaymentData = {
        ...
        accountInfo: {
          type:
            ...
            (paymentMethod === "momo" ? "MoMo" : "TPBank"),
          number: paymentRes.accountNumber,
          name: paymentRes.recipientName || 
            (paymentMethod === "momo" ? "Nguyễn Hữu Giàu" : "richdesu"),
        },
