...
import PaymentModal, { PaymentFormData } from "../../components/admin/modal/PaymentModal";
  ...
  const exportPdf = async (rows: Transaction[]) => {
    ...
    if (!document.getElementById('noto-font')) {
      ...
      try {
        ...
        await (document as any).fonts?.load('16px "Noto Sans"');
      } catch (e) {
        // ignore font load failure; browser will fallback
      }
    }
