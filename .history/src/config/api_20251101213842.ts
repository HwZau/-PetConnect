...
export const API_ENDPOINTS = {
  ...
  PETS: {
    LIST: "/v1/pet/getall",
    DETAIL: (id: string) => `/v1/pet/${id}`,
    USER_PETS: (userId: string) => `/v1/pet/user/${userId}/pets`,
    CREATE: "/v1/pet/create",
    UPDATE: (id: string) => `/v1/pet/update/${id}`,
    DELETE: (id: string) => `/v1/pet/delete/${id}`,
    ADD_PET: (id: string) => `/v1/pet/add/${id}`,
    CREATE_USER_PET: (userId: string) => `/v1/pet/${userId}`,
  },
  ...
  FREELANCERS: {
    LIST: "/v1/freelancers",
    DETAIL: (id: string) => `/v1/freelancers/${id}`,
    SEARCH: "/v1/freelancers/search",
    REVIEWS: (id: string) => `/v1/freelancers/${id}/reviews`,
    PORTFOLIO: (id: string) => `/v1/freelancers/${id}/portfolio`,
  },
  ...
  EVENTS: {
    ...
    JOIN: (id: string) => `/v1/events/${id}/join`,
    LEAVE: (id: string) => `/v1/events/${id}/leave`,
  ...
  // File Upload
  UPLOAD: {
    SINGLE: "/v1/upload/single",
    MULTIPLE: "/v1/upload/multiple",
    AVATAR: "/v1/upload/avatar",
    PET_PHOTO: "/v1/upload/pet-photo",
  },
} as const;
