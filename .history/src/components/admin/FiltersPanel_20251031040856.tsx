...
function FiltersPanel<T extends Record<string, unknown>>({ fields, values, onChange, onReset, className = '' }: FiltersPanelProps<T>) {
  ...
  <h3 className="text-lg font-semibold">{t('Bộ Lọc','Filters')}</h3>
        {advancedFields.length > 0 && (
          ...
          >
            <span className="hidden sm:inline">{showAdvanced ? t('Ẩn nâng cao','Hide advanced') : t('Hiện nâng cao','Show advanced')}</span>
