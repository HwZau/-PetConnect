...
const allFreelancers: Freelancer[] = [
  {
    id: 1,
    name: "Nguyễn Thị Lan",
    subtitle: "Chuyên gia chăm sóc chó",
    avatar: "https://i.pravatar.cc/84?img=10",
    badge: "Hoạt động",
    experience: "5 năm",
    rating: 4.9,
    jobsCompleted: 155,
    servicePrice: "250,000₫/giờ",
    region: "Hà Nội",
  },
  {
    id: 2,
    name: "Trần Văn Minh",
    subtitle: "Huấn luyện viên thú cưng",
    avatar: "https://i.pravatar.cc/84?img=12",
    badge: "Bận",
    experience: "7 năm",
    rating: 4.7,
    jobsCompleted: 210,
    servicePrice: "350,000₫/buổi",
    region: "TP.HCM",
  },
  {
    id: 3,
    name: "Lê Thị Hương",
    subtitle: "Chuyên gia chăm sóc mèo",
    avatar: "https://i.pravatar.cc/84?img=14",
    badge: "Hoạt động",
    experience: "3 năm",
    rating: 4.5,
    jobsCompleted: 98,
    servicePrice: "200,000₫/ngày",
    region: "Đà Nẵng",
  },
  {
    id: 4,
    ...
    avatar: "https://i.pravatar.cc/84?img=11",
    badge: "Tạm ngưng",
    experience: "10 năm",
    rating: 5.0,
    jobsCompleted: 450,
    servicePrice: "500,000₫/lần",
    region: "Hà Nội",
  },
  {
    id: 5,
    name: "Ngô Hoàng Phúc",
    subtitle: "Chuyên gia thú cưng ngoại lai",
    avatar: "https://i.pravatar.cc/84?img=25",
    badge: "Hoạt động",
    experience: "8 năm",
    rating: 4.8,
    jobsCompleted: 180,
    servicePrice: "400,000₫/buổi",
    region: "TP.HCM",
  },
  {
    id: 6,
    name: "Đào Thị Thu",
    subtitle: "Tắm rửa & Cắt tỉa",
    avatar: "https://i.pravatar.cc/84?img=26",
    badge: "Hoạt động",
    experience: "2 năm",
    rating: 4.6,
    jobsCompleted: 50,
    servicePrice: "150,000₫/lần",
    region: "Hải Phòng",
  },
  {
    id: 7,
    name: "Vũ Đình Sơn",
    subtitle: "Chăm sóc thú cưng tại nhà",
    avatar: "https://i.pravatar.cc/84?img=27",
    badge: "Bận",
    experience: "4 năm",
    rating: 4.9,
    jobsCompleted: 120,
    servicePrice: "100,000₫/ngày",
    region: "Hà Nội",
  },
  {
    id: 8,
    name: "Bùi Ngọc Mai",
    subtitle: "Chuyên gia dinh dưỡng thú cưng",
    avatar: "https://i.pravatar.cc/84?img=28",
    badge: "Hoạt động",
    experience: "6 năm",
    rating: 4.7,
    jobsCompleted: 300,
    servicePrice: "50,000₫/tư vấn",
    region: "Đà Nẵng",
  },
  {
    id: 9,
    name: "Lý Văn Hùng",
    subtitle: "Huấn luyện & Dạy bảo",
    avatar: "https://i.pravatar.cc/84?img=29",
    badge: "Hoạt động",
    experience: "9 năm",
    rating: 4.9,
    jobsCompleted: 350,
    servicePrice: "450,000₫/buổi",
    region: "TP.HCM",
  },
  {
    id: 10,
    name: "Trịnh Thị Thảo",
    subtitle: "Pet Sitter tại nhà",
    avatar: "https://i.pravatar.cc/84?img=30",
    badge: "Hoạt động",
    experience: "1 năm",
    rating: 4.4,
    jobsCompleted: 30,
    servicePrice: "180,000₫/ngày",
    region: "Cần Thơ",
  },
];
...
const FreelancersPage: React.FC = () => {
  ...
  const filteredFreelancers = allFreelancers.filter((f) => {
    ...
    if (filter.service !== "All") {
      ...
      if (
        filter.service === "Grooming" &&
        !subtitle.includes("tắm rửa") &&
        !subtitle.includes("cắt tỉa")
      )
        return false;
      if (
        filter.service === "Training" &&
        !subtitle.includes("huấn luyện") &&
        !subtitle.includes("dạy bảo")
      )
        return false;
      if (
        filter.service === "Sitting" &&
        !subtitle.includes("chăm sóc") &&
        !subtitle.includes("pet sitter")
      )
        return false;
      if (
        filter.service === "Medical" &&
        !subtitle.includes("bác sĩ") &&
        !subtitle.includes("dinh dưỡng")
      )
        return false;
    }
    ...
    if (filter.experience !== "All") {
      ...
      if (filter.experience === "3+" && (expValue < 1 || expValue > 5))
        return false; // 1-5 năm
  ...
  const activeFreelancers = allFreelancers.filter(
    (f) => f.badge === "Hoạt động"
  ).length;
  const avgRating = (
    allFreelancers.reduce((sum, f) => sum + f.rating, 0) / allFreelancers.length
  ).toFixed(2);
  const totalJobsCompleted = allFreelancers.reduce(
    (sum, f) => sum + f.jobsCompleted,
    0
  );
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500">
            Quản lý hồ sơ, dịch vụ và hiệu suất của freelancers.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <StatCard
          title="Tổng Freelancers"
          value={allFreelancers.length}
        ...
        />
        <StatCard
          title="Tổng Việc Hoàn Thành"
          value={totalJobsCompleted}
          delta="25% so với tháng trước"
          icon={<AiOutlineTrophy />}
        />
        <StatCard
          title="Hoạt Động/Tổng"
          value={`${activeFreelancers}/${allFreelancers.length}`}
          delta="Cần xem xét"
