...
const FormInput = React.memo(({ 
  ...
  // Build a safe props object by removing any externally passed `value`/`onChange`
      ...
      <div className="relative">
        ...
        {type === 'select' ? (
          <select
            name={name}
            value={formData[name]}
            onChange={handleSelectChange ? (handleSelectChange as React.ChangeEventHandler<HTMLSelectElement>) : (handleInputChange as React.ChangeEventHandler<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>)}
          ...
          <textarea
            ...
            onChange={handleInputChange as React.ChangeEventHandler<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>}
