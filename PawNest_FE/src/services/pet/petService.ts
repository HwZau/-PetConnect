...
export const petService = {
  ...
  // DELETE /api/v1/pet/delete/{id} - Xóa pet (id là userId) (admin)
  async deletePet(userId: string, petId: string): Promise<ApiResponse<void>> {
    return apiClient.delete<void>(API_ENDPOINTS.PETS.DELETE(userId), {
      params: { petId },
    });
  },
